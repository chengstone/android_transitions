...
import universum.studios.android.test.instrumented.TestFragmentActivity;
...
public final class NavigationalTransitionCompatTest extends InstrumentedTestCase {

	@SuppressWarnings("unused")
	private static final String TAG = "NavigationalTransitionCompatTest";

	@Rule
	public final ActivityTestRule<TestFragmentActivity> ACTIVITY_RULE = new ActivityTestRule<>(TestFragmentActivity.class);
	...
	public void testInstantiationWithActivityClass() {
		final TestTransition transition = new TestTransition(TestFragmentActivity.class);
		assertSame(transition.getActivityClass(), TestFragmentActivity.class);
	}

	@Test
	@UiThreadTest
	public void testStartForFragment() throws Exception {
		final FragmentActivity activity = ACTIVITY_RULE.getActivity();
