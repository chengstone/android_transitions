 ...
 */
public final class WindowExtraTransitionsTest extends LocalTestCase {

	@Test(expected = IllegalAccessException.class)
	public void testInstantiation() throws Exception {
		// Act:
		WindowExtraTransitions.class.newInstance();
	}

	@Test(expected = InvocationTargetException.class)
	public void testInstantiationWithAccessibleConstructor() throws Exception {
		// Arrange:
		final Constructor<WindowExtraTransitions> constructor = WindowExtraTransitions.class.getDeclaredConstructor();
	...
	@Test public void testSLIDE_TO_RIGHT_AND_HOLD() {
		// Assert:
		assertThatTransitionHasAttributes(WindowExtraTransitions.SLIDE_TO_RIGHT_AND_HOLD,
	...
	@Test public void testSLIDE_TO_LEFT_AND_HOLD() {
		// Assert:
		assertThatTransitionHasAttributes(WindowExtraTransitions.SLIDE_TO_LEFT_AND_HOLD,
	...
	@Test public void testSLIDE_TO_TOP_AND_HOLD() {
		// Assert:
		assertThatTransitionHasAttributes(WindowExtraTransitions.SLIDE_TO_TOP_AND_HOLD,
	...
	@Test public void testSLIDE_TO_BOTTOM_AND_HOLD() {
		// Assert:
		assertThatTransitionHasAttributes(WindowExtraTransitions.SLIDE_TO_BOTTOM_AND_HOLD,
